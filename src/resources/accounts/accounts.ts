...
import * as AccountsAPI from 'meorphis-test-2/resources/accounts/accounts';
import * as CreditConfigurationAPI from 'meorphis-test-2/resources/accounts/credit-configuration';
